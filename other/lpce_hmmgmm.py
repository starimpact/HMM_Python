# -*- coding: utf-8 -*-
"""
Created on Tue Nov 18 14:32:03 2014
...
def train(lpinfo_list):
    print 'data size:', len(lpinfo_list)
    prior, trans, gmm_list, obs_list = getInitailParamsFromSamplesGMM(lpinfo_list, gmmsize=4)
    nhg0 = nhgmm.siNHMMGMM(prior, trans, gmm_list)
...
train(lpinfo_list[:180])

test(lpinfo_list[150:], hmmgmmfile)
